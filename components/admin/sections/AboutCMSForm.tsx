  ...
  return (
    <Card>
      ...
      <CardContent className="grid gap-6">
        ...
        <TextAreaField name="about.description" label="Description" rows={5} />
        ...
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            variant="accent"
            size="sm"
            onClick={() => images.append({ imageUrl: "", alt: "About image" })}
          >
            Add Image
          </Button>
        </div>
          ...
          {images.fields.map((f, idx) => (
            <div key={f.id} className="grid gap-4 rounded-3xl border border-[color:var(--border)]/15 p-4 md:grid-cols-12">
              ...
              <div className="md:col-span-2 md:flex md:items-end">
                <Button type="button" variant="outline" className="w-full" onClick={() => images.remove(idx)}>
                  Remove
                </Button>
              </div>
            </div>
